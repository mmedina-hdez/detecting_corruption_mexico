...
algorithm = 'pubagging'  # 'hdsrf' or 'pubagging'
param_num = 9993
param_num_act = 0
saving_interval = 1
r = 42
...
for idx_subset, \
    ...
    if algorithm == 'pubagging':
            ...
            X_test_CSU = rbf_feature.transform(X_test_CSU)
            X_test_CSFull = rbf_feature.transform(X_test_CSFull)
            X_calibration_CSU = rbf_feature.transform(X_calibration_CSU)
            X_calibration_CSFull = rbf_feature.transform(X_calibration_CSFull)
