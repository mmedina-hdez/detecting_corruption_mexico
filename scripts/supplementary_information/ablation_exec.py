#Ablation means that I will test the performance differences only with networks and only with domain knowledge
feature_groups = {
    "buyer_cri": "Domain Knowledge",
    "betweenness_norm_buyer": "Network",
    "closeness_buyer": "Network",
    "coread_b": "Network",
    "corestrength_b": "Network",
    "corewdeg_b": "Network",
    "degree_norm_buyer": "Network",
    "eigen_buyer": "Network",
    "ncontracts_b": "Domain Knowledge",
    "prop_b_failedopen": "Domain Knowledge",
    "prop_b_direct": "Domain Knowledge",
    "prop_b_direct_full": "Domain Knowledge",
    "strength_norm_buyer": "Network",
    "active_weeks_bs": "Domain Knowledge",
    "bs_cri": "Domain Knowledge",
    "prop_contracts_bs": "Domain Knowledge",
    "ncontracts_bs": "Domain Knowledge",
    "ncontracts_bs_odds": "Domain Knowledge",
    "ncontracts_bsw": "Domain Knowledge",
    "bs_prop_direct": "Domain Knowledge",
    "spending_bs_aw": "Domain Knowledge",
    "unweighted_competitive_clustering": "Network",
    "bounded_weighted_competitive_clustering": "Network",
    "unbounded_weighted_competitive_clustering": "Network",
    "compliant_submission_period": "Domain Knowledge",
    "contract_period": "Domain Knowledge",
    "contract_price_mx": "Domain Knowledge",
    "betweenness_edge_norm": "Network",
    "entropy_buyer_dependence": "Domain Knowledge",
    "fragmented_contract_odds": "Domain Knowledge",
    "supply_type_goods": "Domain Knowledge",
    "government_level": "Domain Knowledge",
    "legal_framework": "Domain Knowledge",
    "legal_fundament_simplified_art41": "Domain Knowledge",
    "legal_fundament_simplified_art42": "Domain Knowledge",
    "legal_fundament_simplified_art43": "Domain Knowledge",
    "legal_fundament_simplified_missing": "Domain Knowledge",
    "mad": "Domain Knowledge",
    "neighbourhood_cri": "Domain Knowledge",
    "neighborhood_propdirect": "Domain Knowledge",
    "notinRUPC": "Domain Knowledge",
    "procedure_venue_electronic": "Domain Knowledge",
    "procedure_venue_in-person": "Domain Knowledge",
    "procedure_venue_missing": "Domain Knowledge",
    "procedure_venue_mixed": "Domain Knowledge",
    "rf_bl_conformity": "Domain Knowledge",
    "rf_buyer_dependence": "Domain Knowledge",
    "rf_decision_period": "Domain Knowledge",
    "rf_procedure_type": "Domain Knowledge",
    "rf_single_bidder": "Domain Knowledge",
    "rf_submission_period": "Domain Knowledge",
    "supply_type_services": "Domain Knowledge",
    "supplier_cri": "Domain Knowledge",
    "betweenness_norm_supplier": "Network",
    "closeness_supplier": "Network",
    "coread_s": "Network",
    "corestrength_s": "Network",
    "corewdeg_s": "Network",
    "degree_norm_supplier": "Network",
    "eigen_supplier": "Network",
    "ncontracts_s": "Domain Knowledge",
    "prop_s_failedopen": "Domain Knowledge",
    "prop_s_direct": "Domain Knowledge",
    "prop_s_direct_full": "Domain Knowledge",
    "supplier_size": "Domain Knowledge",
    "strength_norm_supplier": "Network",
    "supply_type_missing": "Domain Knowledge",
    "supply_type_works": "Domain Knowledge",
    "tender_period": "Domain Knowledge"
}
...
feature2keep = str(sys.argv[1])
#feature2keep = 'network'
this_subset = int(sys.argv[2])
#this_subset = 2
...
#vars2 remove for ablation
if feature2keep == 'network':
    ablation_vars2remove = [k for k, v in feature_groups.items() if v != "Network"]
elif feature2keep == 'domain_knowledge':
    ablation_vars2remove = [k for k, v in feature_groups.items() if v != "Domain Knowledge"]
#remove all
contracts = contracts.drop(columns=labels2remove + ablation_vars2remove)
...
idx_subset, X_train, y_train, X_test_CSFull, y_test_CSFull, dataid_test_CSFull, supplier_name_test_CSFull, X_calibration_CSFull, y_calibration_CSFull =  subset_list[this_subset], X_train_list[this_subset], y_train_list[this_subset], \
                X_test_CSFull_list[this_subset], y_test_CSFull_list[this_subset], dataid_test_CSFull_list[this_subset], supplier_name_test_CSFull_list[this_subset], X_calibration_CSFull_list[this_subset], y_calibration_CSFull_list[this_subset]
######################### Model Execution ##########################
...
dict_model = {
    ...
    'this_subset' : int(this_subset),
    'feature2keep': str(feature2keep),
    #CSFull
...
if trial_test == True:
    ...
    file_name = f'ABLATIONTEST_{algorithm}_param{param_num}_{str(target_v)}_thissubset{str(this_subset)}_feature2keep{str(feature2keep)}.json'

file_path = results_folder / file_name
with open(file_path, 'w') as f:
    json.dump(results, f)

print(f'######################I finished the thissubset{str(this_subset)} and feature2keep{str(feature2keep)}')
