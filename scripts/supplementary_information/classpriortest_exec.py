...
params = param_combinations_all[param_num]  # Select the specific parameter combination based on the input argument
...
if trial_test == True:
    ...
    file_name = f'CLASSPRIORTEST_{algorithm}_param{param_num}.json'
